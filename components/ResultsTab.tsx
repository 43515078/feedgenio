...
type NutrientRow = {
  key: NutrientKey | "electrolyteBalance";
  label: string;
  obtained: number;
  min: number;
  max?: number;
...
function buildNutrientRows(
  ...
  const nutrientRows: NutrientRow[] = nutrientKeys.map((key) => ({
    key,
  ...
  const electrolyteRequirement =
    requirement.derivedRequirements?.electrolyteBalance;

  const electrolyteMinimum = Number(
    electrolyteRequirement?.min ?? 0
  );

  const rawElectrolyteMaximum =
    electrolyteRequirement?.max;

  const electrolyteMaximum =
    typeof rawElectrolyteMaximum === "number" &&
    Number.isFinite(rawElectrolyteMaximum)
      ? rawElectrolyteMaximum
      : undefined;

  nutrientRows.push({
    key: "electrolyteBalance",
    label: "Balance electrolítico",
    obtained: Number(
      result.derivedMetrics?.electrolyteBalance ?? 0
    ),
    min: Number.isFinite(electrolyteMinimum)
      ? electrolyteMinimum
      : 0,
    max: electrolyteMaximum,
    suffix: " mEq/kg",
    enabled: electrolyteRequirement?.enabled ?? false
  });
...
export default function ResultsTab({
  ...
  useEffect(() => {
    ...
    try {
      ...
      setProductiveCosting({
        ...
        profitPer50Kg: numberOrDefault(
          parsed.profitPer50Kg ?? parsed.marginPercent,
          DEFAULT_PRODUCTIVE_COSTING.profitPer50Kg
        )
      });
    } catch {}
  }, []);
  ...
  const salePer50Kg =
    realCostPer50Kg + productiveCosting.profitPer50Kg;
  ...
  return (
    <>
      <section className="card">
        ...
        <div className="results-requirement-badge">
          <span>Requerimiento activo</span>
        ...
        {!result ? (
          ...
          <>
            <section className="card" style={{ marginTop: 14 }}>
              ...
              <div className="productive-cost-grid">
                <label className="productive-cost-row">
                ...
                <label className="productive-cost-row">
                  ...
                  <div className="productive-money-input">
                    <span>S/</span>
                    <input
                      className="price-input"
                      type="number"
                      min="0"
                      step="0.1"
                      value={productiveCosting.profitPer50Kg}
                      onChange={(event) =>
                        updateProductiveCost(
                          "profitPer50Kg",
                          Number(event.target.value || 0)
              ...
              <div className="cost-summary-sections">
                <section className="cost-summary-section cost-summary-formula">
                  <h3>🌽 Costo de fórmula</h3>
                ...
                <section className="cost-summary-section cost-summary-real">
                  <h3>🏭 Costo real</h3>
                  <div className="cost-summary-grid">
                    <div className="cost-summary-item">
                ...
                <section className="cost-summary-section cost-summary-sale">
                  <h3>💰 Venta sugerida</h3>
                  <div className="cost-summary-grid">
                    <div className="cost-summary-item">
              ...
              <div className="note" style={{ marginTop: 14 }}>
                Los costos humano, máquina, saco y la ganancia fija corresponden
                a cada saco de 50 kg. Los valores quedan guardados automáticamente
                en este dispositivo.
              </div>
            </section>
